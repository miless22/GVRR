...
`)
                        ...
                        .setFooter({ 
                            ...
                            iconURL: 'https://cdn.discordapp.com/attachments/1302220069388029995/1302231063573168138/image-photoaidcom-cropped.webp'
                        });
...
`)
                    ...
                    embed = new EmbedBuilder()
                        .setDescription(`Moderation commands are still in work. Please check back soon!`)
                        .setColor('#ffcc5e')
                        .setFooter({ 
                            text: 'Greenville Roleplay Republic', 
                            iconURL: 'https://cdn.discordapp.com/attachments/1302220069388029995/1302231063573168138/image-photoaidcom-cropped.webp'
                    ...
                    // Create an ephemeral embed message with the button
